...
@app.get('/ros/interfaces/callable-messages')
...
@app.get('/ros/interfaces/message-schema')
...
@app.post('/ros/interfaces/topic-publish')
...
@app.get('/ros/interfaces/topic-publish/history')
...
@app.post('/ros/interfaces/topic-publish/history/reset')
