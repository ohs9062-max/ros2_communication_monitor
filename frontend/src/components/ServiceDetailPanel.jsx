    ...
    <aside className="detail-panel">
      ...
      {service.active_check_supported === false && (
        <p className="notice-text">
          이 Service는 안전 호출 목록에 등록되어 있지 않아 호출 결과와 응답
          시간을 측정하지 않습니다. 목록과 서버 상태만 모니터링합니다.
        </p>
      )}
      ...
      <section className="detail-section">
        ...
        />
        <DetailLine label="상태" value={service.status ?? '-'} />
      ...
      <section className="detail-section">
        ...
        <DetailLine
          label="측정 지원"
          value={service.active_check_supported ? '예' : '아니오'}
        />
        <DetailLine label="마지막 상태" value={activeCheck.last_status ?? '-'} />
        <DetailLine
          label="응답 시간"
